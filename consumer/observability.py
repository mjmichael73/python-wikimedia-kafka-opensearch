...
consumer_indexed_total = Counter(
    "wikimedia_consumer_indexed_total",
    "Documents successfully indexed into OpenSearch",
    ("index",),
)

consumer_dlq_total = Counter(
    "wikimedia_consumer_dlq_total",
    "Messages published to the dead-letter topic",
    ("topic",),
)

consumer_process_errors_total = Counter(
    "wikimedia_consumer_process_errors_total",
    "Message processing failures (before DLQ)",
    ("phase",),
)

consumer_offsets_committed_total = Counter(
    "wikimedia_consumer_offsets_committed_total",
    "Kafka offsets committed after processing",
    ("topic",),
)
